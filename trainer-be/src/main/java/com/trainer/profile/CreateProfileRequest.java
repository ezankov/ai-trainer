...
/**
 * Request DTO for creating an athlete profile.
 * Bean Validation annotations enforce per-field constraints.
 * Cross-field validations (maxHR > restingHR, lthr constraints, race time ordering)
 * are handled separately in the service/validator layer.
 */
